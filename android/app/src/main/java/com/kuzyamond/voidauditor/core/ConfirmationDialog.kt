...
/**
 * Renders the confirmation dialog for risky operations.
 *
 * This is pure UI code — it reads [ConfirmationManager.currentRequest]
 * and delegates user actions back to [ConfirmationManager.confirm] /
 * [ConfirmationManager.cancel]. It contains no domain logic.
 */
@Composable
